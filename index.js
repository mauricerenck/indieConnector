(function() {
  ...
  __component__$7.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/View.vue";
  ...
  var _sfc_render$6 = function render() {
    ...
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Summary")]), _c("k-table", { attrs: { "columns": {
      ...
      return [_c("div", { staticClass: "center-icon" }, [columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "var(--color-red-700)" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "var(--color-yellow-700)" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "var(--color-green-700)" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "var(--color-blue-700)" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "var(--color-purple-700)" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1);
  };
  ...
  __component__$6.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/DetailsByMonth.vue";
  const DetailsByMonth = __component__$6.exports;
  const _sfc_main$5 = {
    props: {
      targets: {
        type: Array,
  ...
  var _sfc_render$5 = function render() {
    ...
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Targets")]), _c("k-table", { attrs: { "columns": {
      ...
      return [_c("span", [columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "var(--color-red-700)" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "var(--color-yellow-700)" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "var(--color-green-700)" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "var(--color-blue-700)" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "var(--color-purple-700)" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1);
  };
  ...
  __component__$5.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/Targets.vue";
  const Targets = __component__$5.exports;
  const _sfc_main$4 = {
    props: {
      sources: Object,
      authors: Object
  ...
  var _sfc_render$4 = function render() {
    ...
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Sources")]), _c("k-grid", { staticStyle: { "gap": "2rem", "--columns": "3" } }, [_c("k-table", { staticStyle: { "--width": "2/3" }, attrs: { "columns": {
      ...
      return [_c("span", [columnIndex === "sum" ? _c("k-icon", { staticStyle: { "color": "var(--color-black)" }, attrs: { "type": "plus" } }) : columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "var(--color-red-700)" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "var(--color-yellow-700)" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "var(--color-green-700)" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "var(--color-blue-700)" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "var(--color-purple-700)" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1)], 1);
  };
  ...
  __component__$4.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/Sources.vue";
  const Sources = __component__$4.exports;
  const _sfc_main$3 = {
    props: {
      outbox: Array
    },
        ...
        this.outbox.forEach((source) => {
          ...
          source.entries.forEach((entry) => {
            const newEntry2 = {
              ...
              webmentions: null,
              url: entry.url,
              status: entry.status === "success" ? '<svg aria-hidden="true" data-type="check" class="k-icon" style="color: var(--color-green-700);"><use xlink:href="#icon-check"></use></svg>' : '<svg aria-hidden="true" data-type="cancel" class="k-icon" style="color: var(--color-red-700);"><use xlink:href="#icon-cancel"></use></svg>',
  ...
  var _sfc_render$3 = function render() {
    ...
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Sent Webmentions")]), _c("k-table", { attrs: { "columns": {
      ...
      return [_c("span", { attrs: { "title": label } }, [columnIndex === "status" ? _c("k-icon", { staticStyle: { "color": "var(--color-purple-700)" }, attrs: { "type": "live" } }) : columnIndex === "updates" ? _c("k-icon", { staticStyle: { "color": "var(--color-purple-700)" }, attrs: { "type": "refresh" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1);
  };
  ...
  __component__$3.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/Sent.vue";
  const Sent = __component__$3.exports;
  const _sfc_main$2 = {
    props: {
      disabled: Boolean,
      queuedItems: Object,
  ...
  var _sfc_render$2 = function render() {
    ...
    return _c("k-panel-inside", [_c("div", { staticClass: "k-webmentions-queue-view" }, [_c("k-header", [_vm._v("IndieConnector")]), _c("k-tabs", { attrs: { "tab": "queue", "tabs": [
      { name: "webmentions", label: "Webmentions", link: "/webmentions" },
      { name: "queue", label: "Queues", link: "/webmentions/queue", badge: _vm.itemsInQueue }
    ], "theme": "warning" } }), _vm.disabled ? _c("k-info-field", { attrs: { "label": "Queue disabled", "text": "The queue feature is disabled. Configure it in your config.php" } }) : _vm._e(), _c("QueueList", { attrs: { "queuedItems": _vm.queuedItems } }), _vm.responses.enabled ? _c("k-info-field", { attrs: { "label": "Responses enabled", "text": "Responses are enabled. Configure them in your config.php" } }) : _vm._e(), _c("ResponseList", { attrs: { "responses": _vm.responses } })], 1)]);
  };
  ...
  __component__$2.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/Queue.vue";
  const Queue = __component__$2.exports;
  const _sfc_main$1 = {
    props: {
      queuedItems: Array
    },
  ...
  var _sfc_render$1 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Queue")]), _vm.processRunning ? _c("k-info-field", { staticClass: "bottom-margin", attrs: { "theme": "warning", "text": "The queue is being processed. Do not leave this page!" } }) : _vm._e(), _c("k-button-group", { staticClass: "bottom-margin" }, [_c("k-button", { attrs: { "variant": "filled", "icon": "refresh", "theme": "aqua-icon", "click": this.processQueue } }, [_vm._v("Process entire queue")]), _c("k-button", { attrs: { "variant": "filled", "icon": "trash", "theme": "red-icon", "disabled": !_vm.hasFailed, "click": () => {
      this.cleanQueue("failed");
    } } }, [_vm._v("Delete failed")]), _c("k-button", { attrs: { "variant": "filled", "icon": "trash", "theme": "orange-icon", "disabled": !_vm.hasErrors, "click": () => {
      this.cleanQueue("error");
    } } }, [_vm._v("Delete errors")])], 1), _c("k-table", { attrs: { "columns": {
  ...
  __component__$1.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/QueueList.vue";
  const QueueList = __component__$1.exports;
  const _sfc_main = {
    props: {
      responses: Object
    },
  ...
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Responses")]), _vm.processRunning ? _c("k-info-field", { staticClass: "bottom-margin", attrs: { "theme": "warning", "text": "The queue is being processed. Do not leave this page!" } }) : _vm._e(), _c("k-button-group", { staticClass: "bottom-margin" }, [_c("k-button", { attrs: { "variant": "filled", "icon": "refresh", "theme": "aqua-icon", "click": this.processQueue } }, [_vm._v(" Process due URLs ")])], 1), _c("k-table", { attrs: { "columns": {
      queueStatus: { label: "Status", type: "html", width: "160px", align: "center" },
  ...
  __component__.options.__file = "/Users/mauricerenck/Sites/kirby-plugins/indieConnector2/src/components/ResponseList.vue";
  const ResponseList = __component__.exports;
