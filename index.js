(function() {
  ...
  var _sfc_render$9 = function render() {
    ...
    return _c("k-panel-inside", [_c("div", { staticClass: "k-webmentions-view" }, [_c("k-header", [_vm._v("IndieConnector")]), _c("k-tabs", { attrs: { "tab": "webmentions", "tabs": [
      { name: "webmentions", label: "Webmentions", link: "/webmentions" },
      { name: "queue", label: "Queues", link: "/webmentions/queue", badge: _vm.itemsInQueue },
      { name: "status", label: "Status", link: "/webmentions/status" }
    ], "theme": "warning" } }), _c("div", { staticClass: "prev-next" }, [_c("button", { staticClass: "k-link k-button", on: { "click": _vm.goToPrevMonth } }, [_c("k-icon", { attrs: { "type": "angle-left" } })], 1), _vm._v(" " + _vm._s(_vm.month) + " / " + _vm._s(_vm.year) + " "), _c("button", { staticClass: "k-link k-button", on: { "click": _vm.goToNextMonth } }, [_c("k-icon", { attrs: { "type": "angle-right" } })], 1)]), _c("DetailsByMonth", { attrs: { "summary": _vm.summary } }), _c("Sources", { attrs: { "sources": _vm.sources, "authors": _vm.authors } }), _c("k-grid", { staticStyle: { "gap": "2rem", "--columns": "2" } }, [_c("Sent", { attrs: { "outbox": _vm.sent } }), _c("Targets", { attrs: { "targets": _vm.targets } })], 1)], 1)]);
  };
  ...
  __component__$9.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/View.vue";
  ...
  var _sfc_render$8 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Summary")]), _c("k-table", { attrs: { "columns": {
    ...
    }, "index": false, "rows": [_vm.targetList] }, scopedSlots: _vm._u([{ key: "header", fn: function({ columnIndex, label }) {
      return [_c("div", { staticClass: "center-icon" }, [columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-red-700), var(--color-red-300))" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-yellow-700), var(--color-yellow-300))" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-green-700), var(--color-green-300))" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-blue-700), var(--color-blue-300))" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-purple-700), var(--color-purple-300))" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1);
  };
  ...
  __component__$8.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/DetailsByMonth.vue";
  const DetailsByMonth = __component__$8.exports;
  const _sfc_main$7 = {
    props: {
      targets: {
        type: Array,
  ...
  var _sfc_render$7 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Targets")]), _c("k-table", { attrs: { "columns": {
    ...
    }, "index": false, "rows": _vm.targetList, "pagination": {
      ...
      return [_c("span", [columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-red-700),var(--color-red-300))" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-yellow-700),var(--color-yellow-300))" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-green-700),var(--color-green-300))" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-blue-700),var(--color-blue-300))" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-purple-700),var(--color-purple-300))" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1);
  };
  ...
  __component__$7.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/Targets.vue";
  const Targets = __component__$7.exports;
  const _sfc_main$6 = {
    props: {
      sources: Object,
      authors: Object
    ...
    methods: {
      ...
      renderIcon(type) {
        switch (type.toLowerCase()) {
          ...
          case "blocked":
            return '<svg xmlns="http://www.w3.org/2000/svg" class="source-type-icon" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="k-icon lucide lucide-ban-icon lucide-ban"><path d="M4.929 4.929 19.07 19.071"/><circle cx="12" cy="12" r="10"/></svg>';
          default:
            return '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="source-type-icon"><path d="M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM9.71002 19.6674C8.74743 17.6259 8.15732 15.3742 8.02731 13H4.06189C4.458 16.1765 6.71639 18.7747 9.71002 19.6674ZM10.0307 13C10.1811 15.4388 10.8778 17.7297 12 19.752C13.1222 17.7297 13.8189 15.4388 13.9693 13H10.0307ZM19.9381 13H15.9727C15.8427 15.3742 15.2526 17.6259 14.29 19.6674C17.2836 18.7747 19.542 16.1765 19.9381 13ZM4.06189 11H8.02731C8.15732 8.62577 8.74743 6.37407 9.71002 4.33256C6.71639 5.22533 4.458 7.8235 4.06189 11ZM10.0307 11H13.9693C13.8189 8.56122 13.1222 6.27025 12 4.24799C10.8778 6.27025 10.1811 8.56122 10.0307 11ZM14.29 4.33256C15.2526 6.37407 15.8427 8.62577 15.9727 11H19.9381C19.542 7.8235 17.2836 5.22533 14.29 4.33256Z"></path></svg>';
        }
      },
      blockEntry(row) {
        panel.api.post(`indieconnector/block/url`, {
          ...
          this.authors.find((author) => author.id === row.id).sourceType = "blocked";
          row.source = this.renderIcon("blocked");
        });
      },
      dropdownOptions(row) {
        if (row.isSource) {
  ...
  var _sfc_render$6 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Sources")]), _c("k-grid", { staticStyle: { "gap": "2rem", "--columns": "3" } }, [_c("k-table", { staticStyle: { "--width": "2/3" }, attrs: { "columns": {
      ...
      mentions: { label: "mentions", type: "html", width: "40px", align: "center" },
      bookmarks: { label: "bookmarks", type: "html", width: "40px", align: "center" }
    }, "index": false, "rows": _vm.authorList, "pagination": {
      page: _vm.pagination.page,
      limit: _vm.pagination.limit,
      total: _vm.pagination.total,
      details: true
      ...
      mentions: { label: "mentions", type: "html", width: "40px", align: "center" },
      bookmarks: { label: "bookmarks", type: "html", width: "40px", align: "center" }
    }, "index": false, "rows": _vm.sources }, scopedSlots: _vm._u([{ key: "header", fn: function({ columnIndex, label }) {
      return [_c("span", [columnIndex === "sum" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-black),var(--color-white))" }, attrs: { "type": "plus" } }) : columnIndex === "likes" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-red-700),var(--color-red-300))" }, attrs: { "type": "heart-filled" } }) : columnIndex === "replies" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-yellow-700),var(--color-yellow-300))" }, attrs: { "type": "chat" } }) : columnIndex === "reposts" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-green-700),var(--color-green-300))" }, attrs: { "type": "indie-repost" } }) : columnIndex === "mentions" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-blue-700),var(--color-blue-300))" }, attrs: { "type": "indie-mention" } }) : columnIndex === "bookmarks" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-purple-700),var(--color-purple-300))" }, attrs: { "type": "bookmark" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }]) })], 1)], 1);
  };
  ...
  __component__$6.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/Sources.vue";
  const Sources = __component__$6.exports;
  const _sfc_main$5 = {
    props: {
      outbox: Array
    },
      ...
      sentList() {
        ...
        this.outbox.forEach((source) => {
          ...
          source.entries.forEach((entry) => {
            ...
            switch (entry.status) {
              case "success":
                entryStatus = '<svg aria-hidden="true" data-type="check" class="k-icon" style="color: light-dark(var(--color-green-700),var(--color-green-400));"><use xlink:href="#icon-check"></use></svg>';
                break;
              case "blocked":
                entryStatus = '<svg xmlns="http://www.w3.org/2000/svg" style="color: light-dark(var(--color-red-700),var(--color-red-300));" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="k-icon lucide lucide-ban-icon lucide-ban"><path d="M4.929 4.929 19.07 19.071"/><circle cx="12" cy="12" r="10"/></svg>';
                break;
              default:
                entryStatus = '<svg aria-hidden="true" data-type="cancel" class="k-icon" style="color: light-dark(var(--color-red-700),var(--color-red-300));"><use xlink:href="#icon-cancel"></use></svg>';
                break;
            }
            const newEntry2 = {
              id: entry.id,
    ...
    methods: {
      blockEntry(row, hostOnly = false) {
        ...
        panel.api.post(`indieconnector/block/url`, {
          ...
          row.status = '<svg xmlns="http://www.w3.org/2000/svg" style="color: light-dark(var(--color-red-700),var(--color-red-300));" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="k-icon lucide lucide-ban-icon lucide-ban"><path d="M4.929 4.929 19.07 19.071"/><circle cx="12" cy="12" r="10"/></svg>';
        });
      },
      dropdownOptions(row) {
        if (row.isSource) {
  ...
  var _sfc_render$5 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Sent Webmentions")]), _c("k-table", { attrs: { "columns": {
    ...
    }, "index": false, "rows": _vm.sentList, "pagination": {
      page: _vm.pagination.page,
      limit: _vm.pagination.limit,
      total: _vm.pagination.total,
      details: true
      ...
      return [_c("span", { attrs: { "title": label } }, [columnIndex === "status" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-purple-700),var(--color-purple-300))" }, attrs: { "type": "live" } }) : columnIndex === "updates" ? _c("k-icon", { staticStyle: { "color": "light-dark(var(--color-purple-700),var(--color-purple-300))" }, attrs: { "type": "refresh" } }) : _c("span", [_vm._v(_vm._s(label))])], 1)];
    } }, { key: "options", fn: function({ row }) {
      return [_c("k-options-dropdown", { attrs: { "options": _vm.dropdownOptions(row) } })];
    } }]) })], 1);
  };
  ...
  __component__$5.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/Sent.vue";
  const Sent = __component__$5.exports;
  const _sfc_main$4 = {
    props: {
      disabled: Boolean,
      queuedItems: Object,
  ...
  var _sfc_render$4 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-panel-inside", [_c("div", { staticClass: "k-webmentions-queue-view" }, [_c("k-header", [_vm._v("IndieConnector")]), _c("k-tabs", { attrs: { "tab": "queue", "tabs": [
      { name: "webmentions", label: "Webmentions", link: "/webmentions" },
      { name: "queue", label: "Queues", link: "/webmentions/queue", badge: _vm.itemsInQueue },
      { name: "status", label: "Status", link: "/webmentions/status" }
    ], "theme": "warning" } }), !_vm.disabled ? _c("QueueList", { attrs: { "queuedItems": _vm.queuedItems } }) : _vm._e(), _vm.responses.enabled ? _c("ResponseList", { attrs: { "responses": _vm.responses, "limit": _vm.responses.limit } }) : _vm._e()], 1)]);
  };
  ...
  __component__$4.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/Queue.vue";
  const Queue = __component__$4.exports;
  const _sfc_main$3 = {
    props: {
      queuedItems: Array
    },
    ...
    methods: {
      ...
      processQueue() {
        ...
        const itemsWithStatus = this.processIndex > 0 ? this.queuedItems.filter(
          (item) => item.queueStatus !== "failed" && item.queueStatus !== "error" && item.queueStatus !== "success"
  ...
  var _sfc_render$3 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Queue")]), _c("k-button-group", { staticClass: "bottom-margin" }, [_c("k-button", { attrs: { "variant": "filled", "icon": _vm.processRunning ? "loader" : "refresh", "theme": this.queueList.length === 0 ? "gray" : "blue", "disabled": this.queueList.length === 0, "click": this.processQueue, "data-type": "loader" } }, [_vm._v("Process queue")]), _c("k-button", { attrs: { "variant": "filled", "icon": "trash", "theme": !_vm.hasFailed ? "gray" : "red", "disabled": !_vm.hasFailed, "click": () => {
      this.cleanQueue("failed");
    } } }, [_vm._v("Delete failed")]), _c("k-button", { attrs: { "variant": "filled", "icon": "trash", "theme": !_vm.hasErrors ? "gray" : "orange", "disabled": !_vm.hasErrors, "click": () => {
      this.cleanQueue("error");
    } } }, [_vm._v("Delete errors")]), _c("k-button", { attrs: { "variant": "filled", "icon": "trash", "theme": _vm.queueList.length === 0 ? "gray" : "orange", "disabled": _vm.queueList.length === 0, "click": () => {
      this.cleanQueue("queued");
    } } }, [_vm._v(" Empty queue ")])], 1), _c("k-table", { attrs: { "columns": {
    ...
    }, "index": false, "rows": _vm.queueList, "pagination": {
      page: _vm.pagination.page,
      limit: _vm.pagination.limit,
      total: _vm.pagination.total,
      details: true
    }, "empty": "The queue is empty" }, on: { "paginate": function($event) {
      _vm.pagination.page = $event.page;
    } }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }, { key: "options", fn: function({ row }) {
      return [_c("k-options-dropdown", { attrs: { "options": _vm.dropdownOptions(row) } })];
    } }]) })], 1);
  };
  ...
  __component__$3.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/QueueList.vue";
  const QueueList = __component__$3.exports;
  const _sfc_main$2 = {
    props: {
      responses: Object,
      limit: Number
    ...
    methods: {
      ...
      processQueue() {
        ...
        this.iteration++;
        panel.api.post(`indieconnector/responses/fill-queue`, {}).then((response) => {
      ...
      processResponses() {
        ...
        this.button.icon = "loader";
        panel.api.post(`indieconnector/responses/process-queue`, {}).then((response) => {
    ...
    computed: {
      queueList() {
        return [
          {
            queueStatus: this.processRunning ? '<span class="status running">running</span>' : '<span class="status idle">idle</span>',
  ...
  var _sfc_render$2 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-headline", { attrs: { "tag": "h2" } }, [_vm._v("Responses")]), _c("k-button-group", { staticClass: "bottom-margin" }, [_c("k-button", { attrs: { "variant": "filled", "icon": this.button.icon, "theme": "blue", "click": this.processQueue, "data-type": "loader" } }, [_vm._v(" " + _vm._s(_vm.button.label) + " ")])], 1), _c("k-table", { attrs: { "columns": {
      queueStatus: { label: "Status", type: "html", width: "160px", align: "center" },
    ...
    }, "index": false, "rows": _vm.queueList, "empty": "No URLs registered. Go post something!" }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }]) })], 1);
  };
  ...
  __component__$2.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/ResponseList.vue";
  const ResponseList = __component__$2.exports;
  const _sfc_main$1 = {
    props: {
      serviceItems: Array,
      value: {
  ...
  var _sfc_render$1 = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("div", [_c("k-items", { attrs: { "items": _vm.serviceItems, "layout": "list", "selecting": true, "selectable": true, "link": true }, on: { "select": _vm.toggle } })], 1);
  };
  ...
  __component__$1.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/fields/ExternalPost.vue";
  const ExternalPostField = __component__$1.exports;
  const _sfc_main = {
    props: {
      features: Object,
      ...
      featureList() {
        return this.features.map((feature) => {
          return {
            ...
            enabled: feature.enabled ? '<div class="icon"><svg aria-hidden="true" data-type="check" class="k-icon" style="color: light-dark(var(--color-green-700),var(--color-green-400));"><use xlink:href="#icon-check"></use></svg></div>' : '<div class="icon"><svg aria-hidden="true" data-type="cancel" class="k-icon" style="color: light-dark(var(--color-red-700),var(--color-red-300));"><use xlink:href="#icon-cancel"></use></svg></div>',
      ...
      webmentionSendSettings() {
        return this.webmentionsSend.map((setting) => {
          return {
            ...
            enabled: setting.enabled ? '<div class="icon"><svg aria-hidden="true" data-type="check" class="k-icon" style="color: light-dark(var(--color-green-700),var(--color-green-400));"><use xlink:href="#icon-check"></use></svg></div>' : '<div class="icon"><svg aria-hidden="true" data-type="cancel" class="k-icon" style="color: light-dark(var(--color-red-700),var(--color-red-300));"><use xlink:href="#icon-cancel"></use></svg></div>',
  ...
  var _sfc_render = function render() {
    var _vm = this, _c = _vm._self._c;
    return _c("k-panel-inside", [_c("div", { staticClass: "k-webmentions-status-view" }, [_c("k-header", [_vm._v("IndieConnector")]), _c("k-tabs", { attrs: { "tab": "status", "tabs": [
      { name: "webmentions", label: "Webmentions", link: "/webmentions" },
      { name: "queue", label: "Queues", link: "/webmentions/queue", badge: _vm.itemsInQueue },
      { name: "status", label: "Status", link: "/webmentions/status" }
    ], "theme": "error" } }), _c("k-headline", { attrs: { "tag": "h3" } }, [_vm._v("Features")]), _c("k-table", { attrs: { "columns": {
      feature: { label: "Feature", type: "text", width: "25%" },
      description: { label: "Description", type: "text" },
      enabled: { label: "Active", type: "html", width: "80px", align: "center" }
    }, "index": false, "rows": _vm.featureList, "empty": "Could not load data" }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }]) }), _c("k-headline", { attrs: { "tag": "h3" } }, [_vm._v("Receiving Webmentions")]), _c("k-table", { attrs: { "columns": {
      description: { label: "Description", type: "text" },
      setting: { label: "Your setting", type: "html" },
      enabled: { label: "Active", type: "html", width: "80px", align: "center" },
      docs: { label: "Docs", type: "html", width: "80px", align: "center" }
    }, "index": false, "rows": _vm.webmentionReceiveSettings, "empty": "Could not load data" }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }]) }), _c("k-headline", { attrs: { "tag": "h3" } }, [_vm._v("Sending Webmentions")]), _c("k-table", { attrs: { "columns": {
      description: { label: "Description", type: "text" },
      setting: { label: "Your setting", type: "html" },
      enabled: { label: "Active", type: "html", width: "80px", align: "center" },
      docs: { label: "Docs", type: "html", width: "80px", align: "center" }
    }, "index": false, "rows": _vm.webmentionSendSettings, "empty": "Could not load data" }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }]) }), _c("k-headline", { attrs: { "tag": "h3" } }, [_vm._v("Mastodon & Bluesky")]), _c("k-table", { attrs: { "columns": {
      description: { label: "Description", type: "text" },
      setting: { label: "Your setting", type: "html" },
      enabled: { label: "Active", type: "html", width: "80px", align: "center" },
      docs: { label: "Docs", type: "html", width: "80px", align: "center" }
    }, "index": false, "rows": _vm.postingSettings, "empty": "Could not load data" }, scopedSlots: _vm._u([{ key: "header", fn: function({ label }) {
      return [_c("span", [_c("span", [_vm._v(_vm._s(label))])])];
    } }]) })], 1)]);
  };
  ...
  __component__.options.__file = "/Volumes/T7/sites/kirby-plugins/indieconnector/src/components/PluginStatus.vue";
  const PluginStatus = __component__.exports;
  panel.plugin("mauricerenck/indieConnector", {
    components: {
      ...
      QueueList,
      ResponseList,
      "k-webmentions-status-view": PluginStatus
    },
    fields: {
